...
For this use case we have chosen a problem described in a [Train & Deploy Census Income Classification Model](train-and-deploy-census-income-classification-model.md) tutorial. We will monitor the model, which will classify whether the income of a given person exceeds $50.000 per year. 
...
* This tutorial is a sequel to [Train & Deploy Census Income Classification Model](train-and-deploy-census-income-classification-model.md) tutorial. You should have a census income classification model already deployed on your cluster.
