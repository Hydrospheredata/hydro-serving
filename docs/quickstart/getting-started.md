...
![Creating an Application from the uploaded model](../.gitbook/assets/application_creation%20%281%29%20%283%29%20%282%29.gif)
...
![](../.gitbook/assets/image%20%283%29%20%284%29%20%287%29.png)
