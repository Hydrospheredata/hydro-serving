$(function() {
  ...
  var springfox = {
    ...
    "securityConfig": function(onSuccess, onError) {
      $.ajax({
        url: this.getBaseUrl() + "/configuration/security.json",
        dataType: 'json',
        success: onSuccess,
        error: onError
      });
    ...
    "uiConfig": function(onSuccess, onError) {
      $.ajax({
        url: this.getBaseUrl() + "/configuration/ui.json",
        dataType: 'json',
        success: onSuccess,
        error: onError
      });
  ...
  function maybePrefix(location, withRelativePath) {
    var pat = /^https?:\/\//i;
    if (pat.test(location) || location.startsWith("/")) {
      return location;
    }
  ...
  function initializeBaseUrl() {
    ...
    $.getJSON(relativeLocation + "/configuration/resources.json", function(data) {
