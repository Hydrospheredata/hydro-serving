...
import io.hydrosphere.serving.manager.service.{
  AggregatedModelInfo,
...
class ModelController(modelManagementService: ModelManagementService)
  ...
  @ApiResponses(
    Array(
      new ApiResponse(
        code              = 200,
        message           = "Model",
        response          = classOf[AggregatedModelInfo],
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        name          = "body",
        value         = "CreateOrUpdateModelRequest",
        required      = true,
        dataTypeClass = classOf[CreateOrUpdateModelRequest],
        paramType     = "body"
      )
    )
  )
  ...
  @Path("/builds/{modelId}")
  @ApiOperation(
    value      = "listModelBuildsByModel",
    notes      = "listModelBuildsByModel",
    nickname   = "listModelBuildsByModel",
    httpMethod = "GET"
  )
  @ApiImplicitParams(
    Array(
  ...
  @ApiOperation(
    value      = "lastModelBuildsByModel",
    notes      = "lastModelBuildsByModel",
    nickname   = "lastModelBuildsByModel",
    httpMethod = "GET"
  )
  @ApiImplicitParams(
    Array(
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        value         = "Model",
        required      = true,
        dataTypeClass = classOf[BuildModelRequest],
        paramType     = "body"
      )
    )
  )
  ...
  @ApiOperation(
    value      = "lastModelVersions",
    notes      = "lastModelVersions",
    nickname   = "lastModelVersions",
    httpMethod = "GET"
  )
  @ApiImplicitParams(
    Array(
  ...
  @Path("version")
  @ApiOperation(
    value      = "Add ModelVersion",
    notes      = "Add ModelVersion",
    nickname   = "addModelVersion",
    httpMethod = "POST"
  )
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        value         = "ModelVersion",
        required      = true,
        dataTypeClass = classOf[CreateModelVersionRequest],
        paramType     = "body"
      )
    )
  )
  ...
  @Path("version")
  @ApiOperation(
    value      = "All ModelVersion",
    notes      = "All ModelVersion",
    nickname   = "allModelVersions",
    httpMethod = "GET"
  )
  @ApiResponses(
    Array(
  ...
  @ApiOperation(
    value      = "Generate payload for model",
    notes      = "Generate payload for model",
    nickname   = "Generate payload for model",
    httpMethod = "GET"
  )
  @ApiImplicitParams(
    Array(
  ...
  def generatePayloadByModelId = path("api" / "v1" / "model" / "generate" / LongNumber / Segment) {
    (modelName, signature) =>
      get {
        complete {
  ...
  @ApiOperation(
    value      = "Submit a new contract for a model",
    notes      = "Submit a new contract for a model",
    nickname   = "Submit a new contract for a model",
    httpMethod = "POST"
  )
  @ApiImplicitParams(
    Array(
      ...
      new ApiImplicitParam(
        name          = "body",
        value         = "ModelContract text message",
        required      = true,
  ...
  def submitTextContract = path("api" / "v1" / "model" / LongNumber / "contract" / "text") {
    modelId =>
      post {
  ...
  @ApiOperation(
    value      = "Submit a new binary contract for a model",
    notes      = "Submit a new binary contract for a model",
    nickname   = "Submit a new binary contract for a model",
    httpMethod = "POST"
  )
  @ApiImplicitParams(
    Array(
      ...
      new ApiImplicitParam(
        name      = "body",
        value     = "ModelContract binary message",
        required  = true,
        paramType = "body"
      )
    )
  ...
  def submitBinaryContract = path("api" / "v1" / "model" / LongNumber / "contract" / "binary") {
    modelId =>
      post {
  ...
  @ApiOperation(
    value      = "Submit a new flat contract for a model",
    notes      = "Submit a flat new contract for a model",
    nickname   = "Submit a new flat contract for a model",
    httpMethod = "POST"
  )
  @ApiImplicitParams(
    Array(
      ...
      new ApiImplicitParam(
        ...
        required      = true,
        dataTypeClass = classOf[ContractDescription],
        paramType     = "body"
      )
    )
  )
  ...
  def submitFlatContract = path("api" / "v1" / "model" / LongNumber / "contract" / "flat") {
    modelId =>
      post {
  ...
  @ApiOperation(
    value      = "Generate payload for model version",
    notes      = "Generate payload for model version",
    nickname   = "Generate payload for model version",
    httpMethod = "GET"
  )
  @ApiImplicitParams(
    Array(
  ...
  def generateInputsForVersion =
    path("api" / "v1" / "model" / "version" / "generate" / LongNumber / Segment) {
      (versionId, signature) =>
        get {
          complete(
  ...
  val routes
    : Route = listModels ~ getModel ~ updateModel ~ addModel ~ buildModel ~ listModelBuildsByModel ~ lastModelBuilds ~
