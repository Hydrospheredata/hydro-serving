...
sealed trait TypedTensor[T] {
  ...
  /**
    ...
    */
  def putAny(tensorProto: TensorProto, data: Seq[Any])(
...
object TypedTensor {
  def apply(dataType: DataType): TypedTensor[_] = {
    dataType match {
      ...
      case DT_INT8 | DT_INT16 | DT_INT32 | DT_QINT8 | DT_QINT16 | DT_QINT32 => IntTensor

      case DT_UINT8 | DT_UINT16 | DT_UINT32 | DT_QUINT8 | DT_QUINT16 => UintTensor
  ...
  object FloatTensor extends TypedTensor[Float] {
    ...
    override def put(tensorProto: TensorProto, data: Seq[Float]): TensorProto =
  ...
  object DoubleTensor extends TypedTensor[Double] {
    ...
    override def put(tensorProto: TensorProto, data: Seq[Double]): TensorProto =
  ...
  object Uint64Tensor extends TypedTensor[Long] {
    ...
    override def put(tensorProto: TensorProto, data: Seq[Long]): TensorProto =
  ...
  object IntTensor extends TypedTensor[Int] {
    ...
    override def put(tensorProto: TensorProto, data: Seq[Int]): TensorProto =
  ...
  object StringTensor extends TypedTensor[String] {
    override def get(tensorProto: TensorProto): Seq[String] =
      tensorProto.stringVal.map(_.toStringUtf8)
    override def put(tensorProto: TensorProto, data: Seq[String]): TensorProto =
  ...
  object BoolTensor extends TypedTensor[Boolean] {
    ...
    override def put(tensorProto: TensorProto, data: Seq[Boolean]): TensorProto =
