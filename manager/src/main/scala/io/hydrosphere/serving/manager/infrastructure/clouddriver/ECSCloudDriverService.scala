...
class ECSServiceWatcherActor(
  ...
  private def createTaskDefinition(service: Service, runtime: DockerImage, modelVersion: DockerImage, host: Option[HostSelector]): TaskDefinition = {
  ...
  def deployService(service: Service, runtime: DockerImage, modelVersion: DockerImage, host: Option[HostSelector]): CloudService = {
