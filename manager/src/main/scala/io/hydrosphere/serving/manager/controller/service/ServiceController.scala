package io.hydrosphere.serving.manager.controller.service
...
import io.hydrosphere.serving.manager.service.management.application.ApplicationManagementService
import io.hydrosphere.serving.manager.service.management.service.{CreateServiceRequest, ServiceManagementService}
