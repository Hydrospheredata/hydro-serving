...
import io.hydrosphere.serving.manager.util.CommonJsonSupport.jsonFormat2
...
import io.hydrosphere.serving.manager.service.management.model.{CreateModelVersionRequest, CreateOrUpdateModelRequest, ModelManagementService}
...
class ModelController(modelManagementService: ModelManagementService) extends ServingDataDirectives {
