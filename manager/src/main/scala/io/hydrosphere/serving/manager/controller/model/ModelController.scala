...
class ModelController(
  ...
  @Path("/deploy")
  @ApiOperation(value = "Upload, release and deploy a model", notes = "Upload, release and deploy a model", nickname = "deployModel", httpMethod = "POST")
  @ApiImplicitParams(Array(
    new ApiImplicitParam(name = "body", value = "CreateOrUpdateModelRequest", required = true,
      dataTypeClass = classOf[CreateOrUpdateModelRequest], paramType = "body")
  ))
  ...
  val routes: Route = listModels ~ getModel ~ updateModel ~ uploadModel ~ deployModel ~ listModelBuildsByModel ~ lastModelBuilds ~
