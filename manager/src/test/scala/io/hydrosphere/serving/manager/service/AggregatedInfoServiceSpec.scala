...
class AggregatedInfoServiceSpec extends GenericUnitTest {
  ...
  "AggregatedInfoService" should "return info for ready to build models" in {
    ...
    val models = Seq(
      Model(1, "model1", "test", ModelType.Tensorflow(), None, ModelContract.defaultInstance, createdTime, createdTime),
      Model(2, "model2", "test", ModelType.Tensorflow(), None, ModelContract.defaultInstance, createdTime, createdTime)
    )
  ...
  it should "return info for built models" in {
    ...
    val unbuiltModel = Model(2, "model2", "test", ModelType.Tensorflow(), None, ModelContract.defaultInstance, createdTime, createdTime)
    val builtModel = Model(1, "model1", "test", ModelType.Tensorflow(), None, ModelContract.defaultInstance, createdTime, createdTime)
    val mVersion = ModelVersion(1, "image", "tag", "sha256", createdTime, builtModel.name, 1, ModelType.Tensorflow(), Some(builtModel.source), Some(builtModel), builtModel.modelContract)
  ...
  it should "return info for models in applications" in {
    ...
    val builtModel1 = Model(2, "model2", "test", ModelType.Tensorflow(), None, ModelContract.defaultInstance, createdTime, createdTime)
    val mVersion1 = ModelVersion(1, "image", "tag", "sha256", createdTime, builtModel1.name, 1, ModelType.Tensorflow(), Some(builtModel1.source), Some(builtModel1), builtModel1.modelContract)
    ...
    val builtModel2 = Model(3, "model3", "test", ModelType.Tensorflow(), None, ModelContract.defaultInstance, createdTime, createdTime)
    val mVersion2 = ModelVersion(2, "image", "tag", "sha256", createdTime, builtModel2.name, 1, ModelType.Tensorflow(), Some(builtModel2.source), Some(builtModel2), builtModel2.modelContract)
