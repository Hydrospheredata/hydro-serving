...
import io.hydrosphere.serving.streaming.service.{ErrorConsumerRecord, SidecarServingProcessor}
...
class SidecarServingProcessorSpec extends FunSpec with Matchers {
  ...
  it("should process failure") {
    import spray.json._
    import io.hydrosphere.serving.streaming.service.ErrorJsonEncoding._
