...
{{- if or (and .Values.global.mongodb.username (not .Values.global.mongodb.database)) (and (not .Values.global.mongodb.username) .Values.global.mongodb.database) }}
...
*/}}
{{- define "mongodb.ingress.apiVersion" -}}
